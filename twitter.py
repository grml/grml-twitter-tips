...
class Api(object):
  ...
  def GetPublicTimeline(self, since_id=None):
    ...
    url = self._host + '/statuses/public_timeline.json'
  ...
  def GetFriendsTimeline(self,
    ...
    '''
    if user:
      url = self._host + '/statuses/friends_timeline/%s.json' % user
    elif not user and not self._username:
      raise TwitterError("User must be specified if API is not authenticated.")
    else:
      url = self._host + '/statuses/friends_timeline.json'
    parameters = {}
  ...
  def GetUserTimeline(self, user=None, count=None, since=None, since_id=None):
    ...
    if since_id:
      parameters['since_id'] = since_id
    if user:
      url = self._host + '/statuses/user_timeline/%s.json' % user
    elif not user and not self._username:
      raise TwitterError("User must be specified if API is not authenticated.")
    else:
      url = self._host + '/statuses/user_timeline.json'
    json = self._FetchUrl(url, parameters=parameters)
    data = simplejson.loads(json)
    self._CheckForTwitterError(data)
    return [Status.NewFromJsonDict(x) for x in data]
  ...
  def GetStatus(self, id):
    ...
    url = self._host + '/statuses/show/%s.json' % id
  ...
  def DestroyStatus(self, id):
    ...
    url = self._host + '/statuses/destroy/%s.json' % id
  ...
  def PostUpdate(self, status, in_reply_to_status_id=None):
    ...
    url = self._host + '/statuses/update.json'
  ...
  def GetReplies(self, since=None, since_id=None, page=None): 
    ...
    '''
    url = self._host + '/statuses/replies.json'
    if not self._username:
      raise TwitterError("The twitter.Api instance must be authenticated.")
    parameters = {}
    if since:
  ...
  def GetFriends(self, user=None, page=None):
    ...
    if user:
      url = self._host + '/statuses/friends/%s.json' % user 
    else:
      url = self._host + '/statuses/friends.json'
    parameters = {}
    if page:
      parameters['page'] = page
    json = self._FetchUrl(url, parameters=parameters)
  ...
  def GetFollowers(self, page=None):
    ...
    if not self._username:
      raise TwitterError("twitter.Api instance must be authenticated")
    url = self._host + '/statuses/followers.json'
    parameters = {}
    if page:
      parameters['page'] = page
    json = self._FetchUrl(url, parameters=parameters)
  ...
  def GetFeatured(self):
    ...
    '''
    url = self._host + '/statuses/featured.json'
    json = self._FetchUrl(url)
    data = simplejson.loads(json)
    self._CheckForTwitterError(data)
    return [User.NewFromJsonDict(x) for x in data]
  ...
  def GetUser(self, user):
    ...
    '''
    url = self._host + '/users/show/%s.json' % user
    json = self._FetchUrl(url)
    data = simplejson.loads(json)
    self._CheckForTwitterError(data)
  ...
  def GetDirectMessages(self, since=None, since_id=None, page=None):
    ...
    '''
    url = self._host + '/direct_messages.json'
    if not self._username:
      raise TwitterError("The twitter.Api instance must be authenticated.")
    parameters = {}
    if since:
  ...
  def PostDirectMessage(self, user, text):
    ...
    if not self._username:
      raise TwitterError("The twitter.Api instance must be authenticated.")
    url = self._host + '/direct_messages/new.json'
  ...
  def DestroyDirectMessage(self, id):
    ...
    '''
    url = self._host + '/direct_messages/destroy/%s.json' % id
    json = self._FetchUrl(url, post_data={})
    data = simplejson.loads(json)
    self._CheckForTwitterError(data)
    return DirectMessage.NewFromJsonDict(data)
  ...
  def CreateFriendship(self, user):
    ...
    '''
    url = self._host + '/friendships/create/%s.json' % user
    json = self._FetchUrl(url, post_data={})
    data = simplejson.loads(json)
    self._CheckForTwitterError(data)
    return User.NewFromJsonDict(data)
  ...
  def DestroyFriendship(self, user):
    ...
    '''
    url = self._host + '/friendships/destroy/%s.json' % user
    json = self._FetchUrl(url, post_data={})
    data = simplejson.loads(json)
    self._CheckForTwitterError(data)
    return User.NewFromJsonDict(data)
  ...
  def CreateFavorite(self, status):
    ...
    '''
    url = self._host + '/favorites/create/%s.json' % status.id
    json = self._FetchUrl(url, post_data={})
    data = simplejson.loads(json)
    self._CheckForTwitterError(data)
    return Status.NewFromJsonDict(data)
  ...
  def DestroyFavorite(self, status):
    ...
    '''
    url = self._host + '/favorites/destroy/%s.json' % status.id
    json = self._FetchUrl(url, post_data={})
    data = simplejson.loads(json)
    self._CheckForTwitterError(data)
    return Status.NewFromJsonDict(data)
  ...
  def GetUserByEmail(self, email):
    ...
    Returns:
      A twitter.User instance representing that user
    '''
    url = self._host + '/users/show.json?email=%s' % email
    json = self._FetchUrl(url)
    data = simplejson.loads(json)
    self._CheckForTwitterError(data)
    return User.NewFromJsonDict(data)
